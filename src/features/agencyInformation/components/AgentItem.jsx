        ...
        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    <label class="relative inline-flex items-center cursor-pointer">
                        {(locked)? <input type="checkbox" value="" className="sr-only peer" checked onClick={() => {locked? setStatus(false): setStatus(true)}}/> : <input type="checkbox" value="" className="sr-only peer" onClick={() => {locked? setStatus(false): setStatus(true)}}/>  }
