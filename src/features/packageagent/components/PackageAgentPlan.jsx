...
import PromotionSmailCard from "../../../components/PromotionSmailCard";
import HeaderAgent from "../../../components/HeaderAgent";

export default function PackageAgentPlan() {
  ...
  return (
    <>
      <HeaderAgent topic="ซื้อแพ็คเกจ" />
      <div>
        <div className=" w-full justify-center flex flex-col items-center">
          <p className=" text-3xl font-semibold text-c-gray3">
          ...
          {toggle ? (
            <div className="flex">
              <button
                ...
                className=" flex  py-2 px-10 text-lg bg-c-blue1 w-fit mt-10 rounded-l-md text-c-white1 transition-all hover:bg-c-blue4 hover:scale-105 active:scale-95 active:bg-c-blue2"
              >
                รายเดือน
              </button>
              <button
                onClick={hdlClickWeekly}
                className=" flex  p-2 px-10 text-lg border text-c-blue1 border-c-blue1 w-fit mt-10 rounded-r-md  transition-all hover:bg-c-blue4 hover:scale-105 active:scale-95 active:bg-c-blue2 hover:text-c-white1"
              >
                รายสัปดาห์
              </button>
            </div>
            ...
            <div className="flex">
              <button
                onClick={hdlClickMonth}
                className=" flex  p-2 px-10 text-lg border text-c-blue1 border-c-blue1 w-fit mt-10 rounded-l-md transition-all hover:bg-c-blue4 hover:scale-105 active:scale-95 active:bg-c-blue2 hover:text-c-white1"
              >
                รายเดือน
              </button>
              <button
                onClick={hdlClickWeekly}
                className=" flex  py-2 px-10 text-lg bg-c-blue1 w-fit mt-10 rounded-r-md  text-c-white1 transition-all hover:bg-c-blue4 hover:scale-105 active:scale-95 active:bg-c-blue2"
              >
                รายสัปดาห์
              </button>
            </div>
        ...
        <div className=" w-full flex flex-col items-center p-5">
          ...
          <p className=" text-c-gray2 w-[60%] text-center">
            ...
            elit. disLorem ipsum dolor sit amet consectetur. Elit sed facilisi
            ac sed elit.{" "}
          </p>
        </div>
      </div>
