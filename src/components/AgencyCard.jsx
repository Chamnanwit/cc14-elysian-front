...
export default function AgencyCard() {
  return (
    <div className=" bg-c-blue3 gap-2 w-[200px] h-fit rounded-lg shadow-lg p-5 flex flex-col items-center text-c-white1">
      <div className=" bg-c-white1 rounded-full w-20 h-20 my-2"></div>
      <div className="flex gap-4 border-b-gray1  w-full text-xs justify-center">
        <div>ชื่อ</div>
